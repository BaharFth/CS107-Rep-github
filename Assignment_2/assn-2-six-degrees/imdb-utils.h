...
{
    cout << "in Function determininPathToData" << endl;
    if (userSelectedPath != NULL) return userSelectedPath;
  
  const char *ostype = getenv("OSTYPE");
  if (strcasecmp(ostype, "linux") == 0) {
      cout << "Little" << endl;
      return "/home/ec2-user/Assignment_2/assn-2-six-degrees/assn-2-six-degrees-data/little-endian/";
  }
      
  if (strcasecmp(ostype, "solaris") == 0) {
      cout << "Little" << endl;
      return "/home/ec2-user/Assignment_2/assn-2-six-degrees/assn-2-six-degrees-data/big-endian/";
  }
